...
-   A sinapomorfia que define o grupo dos Annelia em relação aos filos anteriores é o **metamerismo** (segmentação corporal), que foi o primeiro passo para a evolução das articulações dos artrópodos.
...
## Celoma
 ...
 -   Celoma e as divisões dos anéis por septos fornecem uma espécies de galeria onde o fluído celômico pode circular por ação dos músculos, servindo como um **esqueleto hidrostático**, que permite a movimentação mais rápida e eficiente.
...
-   A metameria também diminui o impacto de lesões, pois se alguns metâmeros estão danificados, outros podem suprir a falta.
...
|-----------------|-------------|----------------|------------|----------------------------------------|----------|
| **Polychaeta**  | Não         | Sim            | Muitas     | Quase 100% marinho                     | 12000    |
...
Clitelo está presente em Oligochaeta e Hirudinea, representando por um anel glandular facilmente reconhecida na região anterior do corpo, que auxilia na reprodução produzindo muco para facilitar a cópula.  

![](images/Clitelo.png)

## Sistema circulatório

-   Algumas espécies possuem pigmentos respiratórios no sangue, como a hemoglobina em *Euzonus*, um poliqueta que habita as praias do Cassino.  
...
-   Clitellata são monóicos (hermafroditas), mas fazem reprodução cruzada. Não libera gametas no ambiente, mas fecunda os ovos dentro do corpo.
